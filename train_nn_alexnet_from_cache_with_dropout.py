...
dropout1 = tf.nn.dropout(X_t, 0.8tra)
h1 = dense_batch_relu(dropout1, 60, phase,'layer1')
dropout2 = tf.nn.dropout(h1, 0.8)
h2 = dense_batch_relu(dropout2, 60, phase, 'layer2')
dropout3 = tf.nn.dropout(h2, 0.8)
h3 = dense_batch_relu(dropout3, 60, phase, 'layer3')
# dropout3 = tf.nn.dropout(h2, 0.8)
logits = dense(h3, n_y, 'logits')
